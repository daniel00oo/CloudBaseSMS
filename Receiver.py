...
class Receiver(object):
	"""
		...
		Variables:
			url - string, used to store the url from which to listen to for messages
			connection - pika.BlockingConnection instance, used to connect to 'url'
			channel - pika.BlockingConnection.channel variable, used to listen to given queues
		...
		Methods:
			...
			callback(ch, method, properties, body)
				Method required by pika. Dictates how the message received will be processed
			setReceive(que)
